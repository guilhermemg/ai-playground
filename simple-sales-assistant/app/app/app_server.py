...
def process_user_message(user_input, all_messages, debug=True):
    ...
    if user_input == "":
        return GenChatOutput(**{"assistance":"Hello! How can I assist you today? What specific product or information are you looking for?"})

    if debug: print("Step 0: User input is not empty.")
    ...
    final_response = assist_utils.get_completion_from_messages(all_messages + messages)
...
def get_generic_assistance(u_input: UserInput):
    response, _ = process_user_message(u_input.msg, [])
